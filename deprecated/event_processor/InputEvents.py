...
from deprecated.event_processor.Gamepads import Gamepads
from deprecated.event_processor.Scheduler import Scheduler
...
class InputEvents:
    ...
    def subscribe(self, actor: Actor):
        ...
        self.subscribers[subscriber] = tuple(k.key for k in keys)
