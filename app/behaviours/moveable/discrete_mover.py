...
class DiscreteMover(Behaviour):
    ...
    '''
    @classmethod
    @handles(MessageTypes.PUSHED_BY, for_=(UnitProtocol,))
    ...
    @classmethod
    @handles(MessageTypes.PUSHED_BY, for_=(CoordinateHolderProtocol,))
    ...
    @classmethod
    @handles(MessageTypes.INTENTION_TO_MOVE_DISCRETE, for_=(CoordinateHolderProtocol,))
